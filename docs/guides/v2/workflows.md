...
| RBAC & authorization | Changed — SUPERADMIN inheritance, finance/logistics heads, STARTUP_DEV | [v2: rbac](../v2/workflows/rbac.md) (shipped with Module 01) · [Module 01 — Super Admin Settings Hub](../../modules/v2/01-superadmin-settings-hub.md) |
...
| Merch pre-orders (Finance) | Built in V2 (M2) | [v2: merch](../v2/workflows/merch.md) (shipped with Module 04) · [Module 04 — Merch Pre-Orders](../../modules/v2/04-merch-pre-orders.md) |
...
| Seeding | Changed — SUPERADMIN seed + default system settings (Module 01) | [Module 01 — Super Admin Settings Hub](../../modules/v2/01-superadmin-settings-hub.md) · V1 baseline: [v1: seeding](../v1/workflows/seeding.md) |
